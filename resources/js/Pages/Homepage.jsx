        ...
        <>
            <div className="bg-base-100 border-b-4 border-dashed border-base-content ">
                <div className="container grid md:flex navbar justify-center">
                    <div className="block md:flex-1 text-center md:text-left">
                ...
                <div className="hero min-h-screen bg-base">
                    <div className="hero-content text-center">
                        <div className="max-w-md">
                            ...
                            <p className="py-6">
                                We are still under construction for the best
                            </p>
            ...
            <footer className="bg-secondary text-neutral-content">
                <div className="container mx-auto footer gap-2 items-center p-4">
                    <div className="mx-auto md:mx-0 items-center grid-flow-col">
                        <svg
                            width="36"
                            height="36"
                            viewBox="0 0 24 24"
                    ...
                    <div className="mx-auto md:mx-0 grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                        <a>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
