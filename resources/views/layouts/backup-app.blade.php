...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    <div
      class="bg-base-100 border-b-4 border-dashed border-base-content w-full">
        ...
        <div class="flex-none">
          <ul class="menu menu-horizontal md:gap-1 md:my-1">
            <li>
              <span
                href="#"
                class="hover:text-white text-sm md:text-base font-normal md:font-semibold px-2 py-1 md:py-2">
                Home
              </span>
            </li>
            <li>
