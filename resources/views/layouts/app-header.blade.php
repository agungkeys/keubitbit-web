    ...
    <div class="container">
      <div class="block md:flex navbar justify-center">
        ...
        <div 
          ...
          x-data="{ data: datamenu, pathname: window.location.pathname.split('/')[1], styleselected: 'text-white font-bold md:font-bold text-base md:text-xl'}"
        >
          <ul class="mx-auto menu menu-horizontal items-center md:my-1">
            <template x-for="item in data">
              <li>
                <a
                  ...
                  class="hover:text-white text-md md:text-lg font-normal md:font-light px-1 md:px-2 py-1 md:py-2"
                >
                  -
              </a>
              </li>
