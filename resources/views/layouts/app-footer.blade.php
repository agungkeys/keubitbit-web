      ...
      <div class="form-control mt-8">
        <div class="join mx-auto">
          <form method="POST" action="{{ route('mailists.store') }}">
            @csrf
            <input type="email" name="email" class="input input-md md:input-lg input-bordered join-item w-64" placeholder="Email for subscribe newsletter" required />
            <button type="submit" class="btn btn-md md:btn-lg btn-secondary join-item rounded-r-full">Subscribe</button>
            @if ($errors->has('email'))
              <label class="label">
...
<footer class="bg-neutral">
  <div class="container">
    <div class="footer gap-2 items-center p-4">
      <div class="mx-auto md:mx-0 items-center grid-flow-col">
        <p class="text-lg text-secondary">Copyright © 2023 - Keubitbit with ❤️</p>
      </div>
      <div class="text-secondary mx-auto md:mx-0 grid-flow-col gap-4 md:place-self-center md:justify-self-end">
